...
class Instance(base.NovaPersistentObject, base.NovaObject,
    ...
    @base.remotable
    def delete_system_metadata_key(self, key):
        """Optimized system metadata delete method.

        This provides a more efficient way to delete a single system metadata
        key, instead of just calling instance.save(). This should be called
        ...
        notifications.send_update(self._context, self, self)
        if not smd_was_changed:
            self.obj_reset_changes(['system_metadata'])
